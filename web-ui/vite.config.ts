...
export default defineConfig({
	...
	resolve: {
		alias: {
			...
			"@runtime-agent-machine-defaults": resolve(__dirname, "../src/core/agent-machine-defaults.ts"),
			...
			"@runtime-in-progress-cap": resolve(__dirname, "../src/core/in-progress-cap.ts"),
